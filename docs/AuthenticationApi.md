...
# **delete_token**
> SuccessData delete_token(token_name, for_agent=for_agent)
...
try:
    # Deletes authentication token data
    api_response = api_instance.delete_token(token_name, for_agent=for_agent)
    pprint(api_response)
except ApiException as e:
...
# **get_token_data**
> TokenDataResponse get_token_data(token_name, for_agent=for_agent)
...
try:
    # Returns authentication token data
    api_response = api_instance.get_token_data(token_name, for_agent=for_agent)
    pprint(api_response)
except ApiException as e:
...
# **get_token_list**
> TokenList get_token_list(for_agent=for_agent)
...
try:
    # Returns list of authentication token data for the authorized user
    api_response = api_instance.get_token_list(for_agent=for_agent)
    pprint(api_response)
except ApiException as e:
