...
# create an instance of the API class
api_instance = swagger_client.RunApi(swagger_client.ApiClient(configuration))
body = swagger_client.EventParam() # EventParam | The defined event name.
...
# create an instance of the API class
api_instance = swagger_client.RunApi(swagger_client.ApiClient(configuration))
body = swagger_client.ResourceParam() # ResourceParam | The defined resource name.
...
# **modify_job**
> str modify_job(job_definitions_file, job_id)
...
# create an instance of the API class
api_instance = swagger_client.RunApi(swagger_client.ApiClient(configuration))
body = swagger_client.OrderFolderParameters() # OrderFolderParameters | parameters to select the jobs to run (optional)
...
api_instance = swagger_client.RunApi(swagger_client.ApiClient(configuration))
job_id = 'job_id_example' # str | The job ID
body = swagger_client.RerunParameters() # RerunParameters | The JSON file with the restart configuration and parameters (optional)
...
# create an instance of the API class
api_instance = swagger_client.RunApi(swagger_client.ApiClient(configuration))
body = swagger_client.ResourceMax() # ResourceMax | The defined resource name.
server = 'server_example' # str | The Control-M Server hosting the resource.
name = 'name_example' # str | Resource name
