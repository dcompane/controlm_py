...
------------- | ------------- | -------------
[**download_report_by_name**](ReportingApi.md#download_report_by_name) | **GET** /reporting/download | Download report by name.
...
report_id = 'report_id_example' # str | Report File Name (optional)
...
------------- | ------------- | ------------- | -------------
 **report_id** | **str**| Report File Name | [optional] 
