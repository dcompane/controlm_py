...
[**em_db_check_space**](ConfigApi.md#em_db_check_space) | **POST** /config/em/db/space | Check available space of EM DB
...
# **em_db_check_space**
> DevicesSpaceInfo em_db_check_space(body=body)
...
# create an instance of the API class
api_instance = controlm_py.ConfigApi(controlm_py.ApiClient(configuration))
body = controlm_py.SysAdminInfo() # SysAdminInfo |  (optional)

try:
    # Check available space of EM DB
    api_response = api_instance.em_db_check_space(body=body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ConfigApi->em_db_check_space: %s\n" % e)
```
...
[**DevicesSpaceInfo**](DevicesSpaceInfo.md)
...
> SuccessData unmanaged_ctm_server(server, host)
...
try:
    # Set server to unmanaged state.
    api_response = api_instance.unmanaged_ctm_server(server, host)
    pprint(api_response)
except ApiException as e:
