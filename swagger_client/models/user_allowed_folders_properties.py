...
class UserAllowedFoldersProperties(object):
    ...
    def __init__(self, allowed_folders_names=None, as2_certificate_alias=None, as2_id=None, as2_public_key_certificate=None, as2_target_folder=None, company=None, description=None, email=None, full_name=None, hashed_password=None, is_ldap_auth=None, name=None, phone_number=None, ssh_public_key=None):  # noqa: E501
