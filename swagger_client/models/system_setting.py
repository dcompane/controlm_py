...
class SystemSetting(object):
    ...
    def __init__(self, saml2_identity_provider=None, new_day_time=None, first_day_of_the_week=None, environment_banner_color=None, environment_title=None, environment_description=None, enforce_site_standards=None, strictnesslevel=None, annotations=None, errors=None):  # noqa: E501
