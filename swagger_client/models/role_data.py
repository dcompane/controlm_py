...
class RoleData(object):
    ...
    def __init__(self, name=None, description=None, allowed_jobs=None, allowed_job_actions=None, privileges=None, folders=None, calendars=None, runas_users=None, workload_policies=None, site_standard=None, site_customization=None, services=None, events=None, mutexes=None, locks=None, semaphores=None, pools=None, variables=None, global_events=None, agent_management=None, plugin_management=None, connection_profile_management=None, runas_definition_management=None):  # noqa: E501
