...
class AgentData(object):
    ...
    def __init__(self, name=None, host=None, node_id=None, ctm=None, ctm_host=None, current_state=None, status=None, status_message=None, operating_system=None, platform=None, version=None, last_update=None, communication_version=None, tag=None, ssl_state=None, host_groups=None, plugins=None):  # noqa: E501
