...
class ClientAccessPrivilegeCategory(object):
    ...
    def __init__(self, self_service_access=None, workload_change_manager_access=None, utilities_access=None, application_integrator_access=None, automation_api_access=None):  # noqa: E501
