...
class ConfigApi(object):
    ...
    def add_host_to_hostgroup(self, body, server, hostgroup, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AgentInGroupParams body: The hostname of the new agent (required)
    ...
    def get_all_ldap_groups(self, **kwargs):  # noqa: E501
        """Get All LDAP groups  # noqa: E501

        Get All LDAP groups  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_ldap_groups(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ldap: The ldap name.
        :return: list[str]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_ldap_groups_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_ldap_groups_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_ldap_groups_with_http_info(self, **kwargs):  # noqa: E501
        """Get All LDAP groups  # noqa: E501

        Get All LDAP groups  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_ldap_groups_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_ldap_groups" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'ldap' in params:
            query_params.append(('ldap', params['ldap']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/config/authorization/ldaps', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def set_agent_parameter(self, body, server, agent, name, **kwargs):  # noqa: E501
        """set agent parameter  # noqa: E501

        Set the value of the specified parameter in the specified agent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_agent_parameter(body, server, agent, name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.set_agent_parameter_with_http_info(body, server, agent, name, **kwargs)  # noqa: E501
        else:
            (data) = self.set_agent_parameter_with_http_info(body, server, agent, name, **kwargs)  # noqa: E501
            return data

    def set_agent_parameter_with_http_info(self, body, server, agent, name, **kwargs):  # noqa: E501
        """set agent parameter  # noqa: E501

        Set the value of the specified parameter in the specified agent.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.set_agent_parameter_with_http_info(body, server, agent, name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'server', 'agent', 'name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_hosts_in_hostgroup(self, body, server, hostgroup, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param AgentInGroupParamsList body: Agent list to update in a hostgroup (required)
        :param str server: The Server the agent is connected to. (required)
        :param str hostgroup: The hostgroup name (required)
        :return: SuccessData
                 If the method is called asynchronously,
