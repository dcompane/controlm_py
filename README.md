...
- API version: 9.21.325
- Package version: 9.21.325
...
*ConfigApi* | [**em_db_check_space**](docs/ConfigApi.md#em_db_check_space) | **POST** /config/em/db/space | Check available space of EM DB
