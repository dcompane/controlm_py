...
class BuildApi(object):
    ...
    def build_file(self, definitions_file, deploy_descriptor_file, **kwargs):  # noqa: E501
        ...
        >>> thread = api.build_file(definitions_file, deploy_descriptor_file, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.build_file_with_http_info(definitions_file, deploy_descriptor_file, **kwargs)  # noqa: E501
        else:
            (data) = self.build_file_with_http_info(definitions_file, deploy_descriptor_file, **kwargs)  # noqa: E501
            return data

    def build_file_with_http_info(self, definitions_file, deploy_descriptor_file, **kwargs):  # noqa: E501
        """Compile definitions file to check its validity  # noqa: E501

        Compile the provided definition file (JSON or zip) to verify it is valid for Control-M.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.build_file_with_http_info(definitions_file, deploy_descriptor_file, async_req=True)
        >>> result = thread.get()
        ...
        if ('deploy_descriptor_file' not in params or
            ...
            raise ValueError("Missing the required parameter `deploy_descriptor_file` when calling `build_file`")  # noqa: E501
