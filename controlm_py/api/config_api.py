...
class ConfigApi(object):
    ...
    def em_db_check_space(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param SysAdminInfo body:
        :return: DevicesSpaceInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            ...
            (data) = self.em_db_check_space_with_http_info(**kwargs)  # noqa: E501
            return data
    ...
    def em_db_check_space_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DevicesSpaceInfo',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def unmanaged_ctm_server(self, server, host, **kwargs):  # noqa: E501
        """Set server to unmanaged state.  # noqa: E501

        Set server to unmanaged state.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unmanaged_ctm_server(server, host, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.unmanaged_ctm_server_with_http_info(server, host, **kwargs)  # noqa: E501
        else:
            (data) = self.unmanaged_ctm_server_with_http_info(server, host, **kwargs)  # noqa: E501
            return data

    def unmanaged_ctm_server_with_http_info(self, server, host, **kwargs):  # noqa: E501
        """Set server to unmanaged state.  # noqa: E501

        Set server to unmanaged state.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unmanaged_ctm_server_with_http_info(server, host, async_req=True)
        >>> result = thread.get()
        ...
        if ('host' not in params or
                params['host'] is None):
            raise ValueError("Missing the required parameter `host` when calling `unmanaged_ctm_server`")  # noqa: E501
