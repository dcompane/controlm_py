...
class DeployApi(object):
    ...
    def delete_job(self, job_path, **kwargs):  # noqa: E501
        """delete a job  # noqa: E501

        Delete a job  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_job(job_path, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_job_with_http_info(job_path, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_job_with_http_info(job_path, **kwargs)  # noqa: E501
            return data

    def delete_job_with_http_info(self, job_path, **kwargs):  # noqa: E501
        """delete a job  # noqa: E501

        Delete a job  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_job_with_http_info(job_path, async_req=True)
        >>> result = thread.get()
        ...
        if ('job_path' not in params or
            ...
            raise ValueError("Missing the required parameter `job_path` when calling `delete_job`")  # noqa: E501
    ...
    def get_deployed_folders_new_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['format', 'folder', 'job', 'ctm', 'server', 'use_array_format']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
