...
class GetManifestParams(object):
    ...
    def __init__(self, category=None, order=None, product_code=None, name=None, install_uri=None, visible=None, icon_base64=None, error=None, error_code=None, full_name=None, short_name=None, sub_category=None, keywords=None, versions=None, group=None):  # noqa: E501
