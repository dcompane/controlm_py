...
class UserHeader(object):
    ...
    def __init__(self, name=None, full_name=None, description=None, status=None, last_updated=None, created=None, account_locked_on_date=None, member_of=None):  # noqa: E501
    ...
    def account_locked_on_date(self):
        """Gets the account_locked_on_date of this UserHeader.  # noqa: E501

        account locked on date (output only)  # noqa: E501

        :return: The account_locked_on_date of this UserHeader.  # noqa: E501
        :rtype: str
        """
    ...
    def account_locked_on_date(self, account_locked_on_date):
        """Sets the account_locked_on_date of this UserHeader.

        account locked on date (output only)  # noqa: E501

        :param account_locked_on_date: The account_locked_on_date of this UserHeader.  # noqa: E501
        :type: str
        """
