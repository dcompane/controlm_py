...
class ItemInfo(object):
    ...
    def __init__(self, name=None, id=None, description=None, created_time=None, updated_time=None, updated_time_utc=None, username=None, enabled=None, site_standard=None, site_standard_id=None):  # noqa: E501
