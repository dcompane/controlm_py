...
class CtmAdvancedDetails(object):
    ...
    def __init__(self, name=None, host=None, state=None, message=None, version=None, ctm_type=None, type=None, cmc_managed=None, current_state=None, admin_agent_status=None):  # noqa: E501
