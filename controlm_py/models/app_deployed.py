...
class AppDeployed(object):
    ...
    def __init__(self, displayname=None, name=None, version=None, default_type=None, last_deployed=None, last_published=None, icon_base64=None, created_on=None, created_by=None):  # noqa: E501
