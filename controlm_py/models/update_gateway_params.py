...
class UpdateGatewayParams(object):
    ...
    def __init__(self, name=None, host=None, desired_state=None, check_interval=None, additional_parameters=None):  # noqa: E501
        """UpdateGatewayParams - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._host = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateGatewayParams, dict):
