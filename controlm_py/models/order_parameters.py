...
class OrderParameters(object):
    ...
    def __init__(self, create_duplicate=None, hold=None, ignore_criteria=None, independent_flow=None, order_date=None, order_into_folder=None, order_into_folder_order_id=None, variables=None, wait_for_order_date=None):  # noqa: E501
    ...
    def order_into_folder(self, order_into_folder):
        ...
        if order_into_folder not in allowed_values:
            raise ValueError(
