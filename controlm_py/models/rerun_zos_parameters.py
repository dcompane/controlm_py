...
class RerunZosParameters(object):
    ...
    def __init__(self, _from=None, to=None, cleanup=None, recapture_abend=None, recapture_condition_code=None, step_adjustment=None, restart_parm_member_name=None):  # noqa: E501
