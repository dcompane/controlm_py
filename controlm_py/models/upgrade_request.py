...
class UpgradeRequest(object):
    ...
    def __init__(self, ctm=None, agent=None, type=None, version=None, activity_name=None, install_user=None, notify_address=None, description=None, use_network_deployment=None, java_home=None):  # noqa: E501
