...
class ClientAccessPrivilegeCategory(object):
    ...
    def __init__(self, controlm_web_client_access=None, self_service_access=None, workload_change_manager_access=None, utilities_access=None, application_integrator_access=None, automation_api_access=None, workflow_insights_access=None):  # noqa: E501
