...
class TokenDataResponse(object):
    ...
    def __init__(self, token_name=None, token_type=None, token_value=None, user=None, roles=None, expiration_date=None, created_date=None, last_updated_date=None, server=None, server_host=None, server_id=None, tag=None):  # noqa: E501
