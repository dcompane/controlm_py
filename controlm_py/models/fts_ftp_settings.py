...
class FtsFtpSettings(object):
    ...
    def __init__(self, server_enabled=None, port=None, authentication_method=None, secured=None, keystore_file_path=None, keystore_file_password=None, ciphers=None, listen_for_implicit_connection=None, passive_ports=None):  # noqa: E501
