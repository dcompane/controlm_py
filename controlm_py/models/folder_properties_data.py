...
class FolderPropertiesData(object):
    ...
    def __init__(self, name=None, authorized_internal_users=None, authorized_external_users_and_groups=None, delete_files_after_download=None, notify_by_email_when_file_arrive=None, retention_policy=None, size_limit=None, allowed_file_pattern=None, blocked_file_pattern=None, access_type=None, access_level=None, delete_files_after_download_by_external_users=None, fixed_sub_folders=None, authorized_external_users_and_groups_extended=None):  # noqa: E501
